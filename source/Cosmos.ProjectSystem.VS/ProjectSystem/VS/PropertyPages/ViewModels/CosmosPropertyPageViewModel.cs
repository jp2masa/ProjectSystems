...
namespace Cosmos.ProjectSystem.VS.PropertyPages.ViewModels
{
    internal class CosmosPropertyPageViewModel : PropertyPageViewModel
    {
        ...
        public bool DebugEnabled
        {
            ...
            set => SetProperty(nameof(DebugEnabled), value.ToString(CultureInfo.InvariantCulture), nameof(DebugEnabled));
        }
        ...
        public bool StackCorruptionDetectionEnabled
        {
            ...
            set => SetProperty(nameof(StackCorruptionDetectionEnabled), value.ToString(CultureInfo.InvariantCulture), nameof(StackCorruptionDetectionEnabled));
        }
        ...
        public bool IgnoreDebugStubAttribute
        {
            ...
            set => SetProperty(nameof(IgnoreDebugStubAttribute), value.ToString(CultureInfo.InvariantCulture), nameof(IgnoreDebugStubAttribute));
        }
    }
}
