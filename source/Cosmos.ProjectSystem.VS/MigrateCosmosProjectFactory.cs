            ...
            out Guid pguidNewProjectFactory)
        {
            ...
            using (var projectStream = File.OpenRead(bstrFileName))
            {
                ...
                else
                {
                    ...
                    if (projectReferencesWithoutPlugsProjects.Skip(1).Any())
                    {
                        ...
                        var codeProjectName = projectName.EndsWith("Boot", StringComparison.OrdinalIgnoreCase) ? projectName.TrimSuffix("Boot") : projectName;
